  ...
  return (
    <div>
        <div className='text-center p-5'>
            <span className='text-xs'>Logisitics & Transportation</span>
            <h3 className='text-3xl font-bold text-lightBlue'>How it Works</h3>
            <p className='text-xs font-light '>You choose the cities where you&apos;d like to deliver. All deliveries are 

  ...
  return (
    <div>
        <div className='p-5 py-10'>
            ...
            <p className='text-lightBlue font-thin text-left w-4/12 '>Welcome to our transportation services agency. We are the best at our transportation services ever.</p>
